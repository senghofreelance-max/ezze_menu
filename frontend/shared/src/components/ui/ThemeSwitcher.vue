<template>
    <div class="flex items-center">
        <EzzeButton
            ...
            variant="icon"
            :icon="currentIcon"
            class="w-10! h-10! rounded-xl! bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm transition-all duration-200"
...
import EzzeButton from "@/components/ui/Form/EzzeButton.vue";
